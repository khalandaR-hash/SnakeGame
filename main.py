...
snake_block = 10
snake_speed = 7  # Speed of snake (Player)


# Render Score Label
def score(score):
    # Size and font of score label (Top-Left)
    score_font = pygame.font.SysFont("Times Newroman", 10)
...
def snake(snake_block, snake_list):
    for x in snake_list:
        pygame.draw.rect(display, green, [
                         x[0], x[1], snake_block, snake_block], border_radius=4)
...
def gameLoop():
    ...
    while not game_over:
        ...
        while game_close == True:
            ...
            message("You Lost! Press Space Again or Q to Quit", Pink, 35)
